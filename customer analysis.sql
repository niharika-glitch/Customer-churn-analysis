...
select max(order_amount) from customer_orders;
select min(order_amount) from customer_orders;
...
select count(payment_status) as pending_orders from payments where payment_status="pending";
 ...
 ---calculating total order and sales on the basis of status  for FY 2020-2021 individually
...
select count(payment_id) ,round(SUM(payment_amount))as sales FROM payments WHERE payment_date BETWEEN "01-01-2020"  and  "31-12-2020"
group by payment_status having payment_status="completed";

SELECT count(payment_id),round(SUM(payment_amount)) FROM payments WHERE payment_date BETWEEN "01-01-2020"  and  "31-12-2020" 
group by payment_status having payment_status="failed";

SELECT count(payment_id), round(SUM(payment_amount)) FROM payments WHERE payment_date BETWEEN "01-01-2020"  and  "31-12-2020" 
group by payment_status having payment_status="pending";

---calculating total order and amt recieved on the basis of status  for FY 2021-2022
select count(payment_id) as total_orders from payments where payment_date BETWEEN "01-01-2021"  and  "31-12-2022";
...
select count(payment_id) as total_orders from payments where payment_date BETWEEN "01-01-2022"  and  "31-12-2023";
...
select count(payment_id) as total_orders from payments where payment_date BETWEEN "01-01-2023"  and  "31-12-2024";
...
select count(payment_id) as total_orders from payments where payment_date BETWEEN "01-01-2024"  and  "31-12-2025";
